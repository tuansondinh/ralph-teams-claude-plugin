---
name: teams-reviewer
description: "Opus reviewer subagent. Reviews the full implementation against acceptance criteria, runs build/test checks, optionally uses Multi-CLI (Ask-Codex) for a second opinion, writes findings to .build/REVIEW.md."
model: opus
---
...
Read `.build/PLAN.md` to understand:
...
Write your findings to `.build/REVIEW.md`:
...
- Always write `.build/REVIEW.md` — this is your only output.
